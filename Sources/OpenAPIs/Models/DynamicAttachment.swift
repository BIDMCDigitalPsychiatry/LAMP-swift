...
public struct DynamicAttachment: Codable {
    ...
    public var requirements: [AnyCodable]?

    public init(key: String? = nil, from: String? = nil, to: String? = nil, triggers: [AnyCodable]? = nil, language: String? = nil, contents: String? = nil, requirements: [AnyCodable]? = nil) {
        self.key = key
        self.from = from
        self.to = to
